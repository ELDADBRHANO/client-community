const getCommunitiesApi = 'https://community-server.onrender.com/api/products/getProducts'
const postCommunitiesApi = 'https://community-server.onrender.com/api/products/getProducts'
